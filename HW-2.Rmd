...
* `income`
* `job`
* One more variable of your choice, keeping in mind in HW-3, you will be fitting
a logistic regression to predict gender.
...
In the file `HW-2_Shiny_App.Rmd`, build the Shiny App discussed in Lec09 on Monday 10/3:
